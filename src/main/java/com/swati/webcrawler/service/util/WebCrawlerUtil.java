...
public class WebCrawlerUtil {
	...
	public static Optional<PageDetail> crawl(final String url) {
        ...
        try {
            ...
            //System.out.println("image are "+images);
	...
	public static boolean isValidURL(String nextUrl, Set<String> crawledUrls, URLFilterStategy strategy) {
		if(strategy != null && !strategy.include(nextUrl)){
			return false;
		}
		if(crawledUrls.contains(nextUrl)) { return false; }
